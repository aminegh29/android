...
public class Securite_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.securite_edit);
            ...
            userRef.get().addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    if (document != null && document.exists()) {
                        ...
                        Toast.makeText(Securite_edit.this, "Document does not exist", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Securite_edit.this, "Error getting document: " + task.getException(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
                    ...
                    .addOnSuccessListener(aVoid -> {
                        user.updatePassword(newPass)
                                .addOnCompleteListener(task -> {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(Securite_edit.this, "Modifications enregistrées avec succès", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(Securite_edit.this, Securite.class);
                                        startActivity(intent);
                                        finish();
                                    } else {
                                        Toast.makeText(Securite_edit.this, "Erreur lors de la mise à jour du mot de passe", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    })
                    .addOnFailureListener(e -> Toast.makeText(Securite_edit.this, "Erreur lors de l'enregistrement des modifications", Toast.LENGTH_SHORT).show());
        }
    }
